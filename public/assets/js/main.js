...
$(document).ready(function(){
  ...
  //------- Active Nice Select --------//
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        loop:true,
        nav:true,
        navText:["<img src='../public/assets/img/banner/prev.png'>","<img src='../public/assets/img/banner/next.png'>"],
        dots:false
    });
    ...
    $(".active-product-area").owlCarousel({
        ...
        loop:true,
        nav:true,
        navText:["<img src='../public/assets/img/product/prev.png'>","<img src='../public/assets/img/product/next.png'>"],
        dots:false
    });
